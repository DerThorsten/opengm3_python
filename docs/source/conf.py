...
breathe_projects = { 'opengm_python': '../xml/' }
...
exhale_args = {
    ...
    "rootFileName":          "opengm_python_api.rst",
    "rootFileTitle":         "opengm_python API",
...
breathe_default_project = 'opengm_python'

templates_path = ['_template']
source_suffix = '.rst'
master_doc = 'index'
project = 'opengm_python'
...
htmlhelp_basename = 'opengm_python_doc'